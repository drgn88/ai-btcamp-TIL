...
- [Counter 실습](#counter-실습)
  ...
  - [결과 이미지](#결과-이미지)
  - [counter1\_xpro.v - Reset을 안 주는 경우(Error Case)](#counter1_xprov---reset을-안-주는-경우error-case)
    - [결과 사진](#결과-사진)
...
## counter1_xpro.v - Reset을 안 주는 경우(Error Case)
...
<img src="./img_250715/without_auto_tracing.png" height=20%><br>

- RTL과 달리 GLS는 원인신호(cnt1)가 Unknown이면 파생신호(ind_cnt_xpro)도 계속 Unknown 상태로 출력된다
- Debugging하기에 더 용이하다
