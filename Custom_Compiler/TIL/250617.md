...
3. 마커를 더블 클릭하면, 마커의 위치를 설정할 수 있다
   - 그림은 x축의 위치를 0.5V로 설정한 모습이다

### 시뮬레이션 저장
![alt text](../image/스크린샷%202025-06-17%20160430.png)<br>
![alt text](../image/스크린샷%202025-06-17%20160436.png)<br>
![alt text](../image/스크린샷%202025-06-17%20160446.png)<br>
1. 시뮬레이션 Session에서 save state를 누른다
2. 그러면 저장 옵션이 나오면서 저장을 할 수 있다
3. 저장을 하면 library에 시뮬레이션 파일이 생성된다
   - 필자는 NOT_sim이라는 이름으로 파일을 저장했다
   - NOT_sim 파일을 누르면 내가 수행하던 시뮬레이션을 그대로 불러올 수 있다
